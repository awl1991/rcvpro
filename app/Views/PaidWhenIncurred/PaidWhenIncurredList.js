...
import PWIItem from './PWIItem'
const nanoid = require('nanoid/non-secure')

class PaidWhenIncurredList extends Component  {
  ...
  clearItem = (arr, key) => {
   ...
   /*
  Add/Delete methods for Items in List */
  addItem = () => {
    const key = nanoid(6)   
...
export default inject('totals')(observer(PaidWhenIncurredList))
